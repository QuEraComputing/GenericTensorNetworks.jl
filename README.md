...
Similarly, one can select tensor network structures for solving other problems like `MaximalIndependentSet`, `MaxCut`, `Matching`, `Coloring{K}`, `PaintShop` and `set_packing`.
