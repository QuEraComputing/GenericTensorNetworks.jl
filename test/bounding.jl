...
@testset "bounding contract" begin
    ...
    rawcode = independent_set_network(random_regular_graph(10, 3); optimizer=nothing).code
    optcode = independent_set_network(random_regular_graph(10, 3); optimizer=GreedyMethod()).code
